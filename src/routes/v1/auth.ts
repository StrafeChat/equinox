...
router.post<{}, {}, RegisterBody>("/register", cors({ origin: process.env.FRONTEND_URL }), JoiRegister, async (req, res) => {
    const { email, global_name, username, discriminator, password, dob, locale } = req.body;
